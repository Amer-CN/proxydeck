...
# ---------------------------------------------------------------------------
# 模型元数据（Agent 配置指南用）
# 腾讯后端没有元数据端点，以下为实测整理：上下文/最大输出（token）、
# 思考级别（reasoning_effort 取值）、备注。max_tokens 由后端校验，
# 超限直接报错，务必按此表填写。
# ---------------------------------------------------------------------------
MODEL_META = {
    ...
    "glm-5.1":        {"maxInput": 131072,  "maxOutput": 32768, "reasoning": "low/medium/high", "note": ""},
    "glm-5v-turbo":   {"maxInput": 131072,  "maxOutput": 16384, "reasoning": "off", "note": "视觉模型"},
    "kimi-k3":        {"maxInput": 262144,  "maxOutput": 65536, "reasoning": "low/medium/high", "note": ""},
    "kimi-k2.7":      {"maxInput": 262144,  "maxOutput": 65536, "reasoning": "low/medium/high", "note": ""},
    "kimi-k2.6":      {"maxInput": 262144,  "maxOutput": 65536, "reasoning": "low/medium/high", "note": ""},
    "kimi-k2.5":      {"maxInput": 262144,  "maxOutput": 32768, "reasoning": "low/medium/high", "note": ""},
    ...
    "deepseek-v3.2":  {"maxInput": 131072,  "maxOutput": 32768, "reasoning": "low/medium/high", "note": ""},
    "minimax-m3-pay": {"maxInput": 1048576, "maxOutput": 65536, "reasoning": "low/medium/high", "note": ""},
    "minimax-m3":     {"maxInput": 1048576, "maxOutput": 65536, "reasoning": "low/medium/high", "note": ""},
    "hy3-preview-agent": {"maxInput": 262144, "maxOutput": 65536, "reasoning": "low/medium/high", "note": ""},
    "hy3":            {"maxInput": 262144,  "maxOutput": 65536, "reasoning": "low/medium/high", "note": ""},
    "hy3-preview":    {"maxInput": 262144,  "maxOutput": 65536, "reasoning": "low/medium/high", "note": ""},
    "auto":           {"maxInput": 1048576, "maxOutput": 65536, "reasoning": "low/medium/high", "note": "后端自动路由到合适模型"},
}


@app.get("/model/info")
def model_info(authorization: Optional[str] = Header(default=None),
               x_api_key: Optional[str] = Header(default=None, alias="X-Api-Key")):
    """每个模型的 Agent 填写参数（上下文/最大输出/思考级别），实测整理。"""
    _check_auth(authorization, x_api_key)
    out = []
    for m in get_models():
        ...
        out.append({
            "name": m,
            "maxInput": meta.get("maxInput"),
            "maxOutput": meta.get("maxOutput"),
            "reasoning": meta.get("reasoning", "low/medium/high"),
            "note": meta.get("note", ""),
        })
    return out

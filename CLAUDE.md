...
- **段位按"本版内容最高档"现算，不沿用旧口径**：v3.10.8（2026-09-12）装进了
  ...
  下一次含新功能直接 **3.11.0**（3.10.8→3.11.0 合法，不必补 3.10.9）。
...
- 下一版待办：暂无（v3.10.8 已发版）；新坑/结论随时按惯例入册
